...
CONFIG.LOGDIR = '/export/data/tmilbich/omair_data/alignment_logs/'
...
# Path to tfrecords.
CONFIG.PATH_TO_TFRECORDS = '/export/data/tmilbich/omair_data/penn_action_tf_records/tf_records_penn_action/%s_tfrecords/'
...
CONFIG.MODEL.RESNET_PRETRAINED_WEIGHTS = '/export/data/tmilbich/omair_data/tcc_model/resnet50v2_weights_tf_dim_ordering_tf_kernels_notop.h5'
